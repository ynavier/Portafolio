  ...
  return (
    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
      <button
        ...
        className="flex items-center space-x-2 bg-blue-600 dark:bg-blue-500 hover:bg-blue-700 dark:hover:bg-blue-600 text-white px-8 py-[0.375em] rounded-lg font-semibold text-xl transition-all duration-150 ease-in-out cursor-pointer hover:scale-105 active:scale-95
